    ...
    where (
    DBT_INTERNAL_TARGET.review_date >= to_timestamp_tz('2012-01-01 00:00:00+00:00')
    and DBT_INTERNAL_TARGET.review_date < to_timestamp_tz('2013-01-01 00:00:00+00:00')
    ...
    (
        ...
        from AIRBNB.DBT_MYDEV_MART.mart_fullmoon_reviews__dbt_tmp_2012
    )
